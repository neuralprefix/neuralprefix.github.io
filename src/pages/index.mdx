...
import nprefix_arch from "../assets/nprefix_arch_simple2.png";
...
import print from "../assets/NeuralPrefix_percom25.pdf"
import nprfix_pipeline from "../assets/nprefix_pipeline.png"
...
{`
  table tr:nth-child(2) {
    ...
    border-top: 2px solid #ccc; /* Add line above second row */
  }
...
{/* | Category                    | Task                                      | Seen (Training)      | Unseen (Test)|
|-----------------------------|-------------------------------------------|-----------|-----|
| Traditional Imputation      | Imputation on the same modality and configuration|<Figure caption=""> <Video source={counterclockwise} /></Figure> | <Figure caption=""> <Video source={counterclockwise} /></Figure> | 
| NeuralPrefix *(domain-OOD)* | imputation on unseen sensor configuations and deployment|<Figure caption="Configuration A"> <Video source={slideright} /></Figure> | <Figure caption="Configuration B"> <Video source={counterclockwise}  /></Figure>| 
| NeuralPrefix *(sensor-OOD)* | imputation on unseen sensor modality|<Figure caption="Sensor A"> <Video source={soli} /></Figure>  | <Figure caption="Sensor Modality B"> <Video source={counterclockwise} /></Figure> |  */}


| Imputation Task                                              | Seen (Training)            | Unseen (Test)|
|---------------------------------------------------|----------------------------|--------------|
| traditional |<Figure caption="  "> <Video source={counterclockwise} /></Figure> | <Figure caption="  "> <Video source={counterclockwise} /></Figure> | 
| cross domain   |<Figure caption="Conf. A"> <Video source={push} /></Figure> | <Figure caption="Conf. B"> <Video source={counterclockwise}  /></Figure>| 
| cross sensor |<Figure caption="Sensor A"> <Video source={soli} /></Figure>  | <Figure caption="Sensor B"> <Video source={counterclockwise} /></Figure> | 
...
{/* <Figure
    caption="A plugin that preceds task model and make them capbable of handling intermittency across domains"
  >
    <Image source={nprfix_pipeline} altText="" />
</Figure> */}
</HighlightedSection>
...
Above is an illustration. The first pane shows the raw sensory data (RF signal) of hand gesture. In the second pane, we focus on the highest energy blob to elminate less significant movements and highlight the main object's motion. It can be seen that the motion follows a continuous curve, confirming that despite noise, the dominant movement pattern remains smooth.
