...
import qualitative from "../assets/evaluation.png"
...
## Smooth and common (latent) dynamics
...
## Performance
 ...
 <Figure
  ...
  >
    <Image source={qualitative} altText="Qualitative Evaluation" />
</Figure> 




| Datasets | Model         | SSIM↑ | MSE↓ | 
|----------|--------------|--------|------|
| **MCD**  | Mean         | 0.7534 | 0.0017 | 
|          | Expectation Maximization | 0.6582 | 0.0035 |
|          | Optical Flow | 0.7831 | 0.0018 | 
|          | Generative SOTA         | 0.8726 | 0.0015 | 
|          | NeuralPrefix | **0.9399** | **0.0007** |
